...
export function AgriculturaTab() {
  return (
    <SimpleMetricsTab
      ...
      kpis={[{ label: '% atual', value: '32%' }, { label: 'Meta PNAE', value: '30%' }, { label: 'Nº fornecedores', value: '18' }]}
      data={[{ label: 'Jan', value: 28 }, { label: 'Fev', value: 30 }, { label: 'Mar', value: 33 }, { label: 'Abr', value: 32 }]}
    />
  )
}
